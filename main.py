...
meat_img = pygame.image.load("images/buttons/boton_carne.jpeg").convert_alpha()
lech_img = pygame.image.load("images/buttons/boton_lechuga.jpeg").convert_alpha()
toma_img = pygame.image.load("images/buttons/boton_tomate.jpeg").convert_alpha()
